...
static const std::string rocksdb_build_git_sha  = "eb9a80fe1f18017b4d7f4084e8f2554f12234822";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:v7.7.3";
#define HAS_GIT_CHANGES 0
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2022-10-11 08:49:59";
#else
