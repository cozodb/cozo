...
podman run --rm -v $PWD:/work ghcr.io/cross-rs/aarch64-unknown-linux-gnu:main strip /work/release/release/cozoserver-${VERSION}-linux-arm64
podman run --rm -v $PWD:/work ghcr.io/cross-rs/x86_64-unknown-linux-gnu:main strip /work/release/release/cozoserver-${VERSION}-linux-x86_64
